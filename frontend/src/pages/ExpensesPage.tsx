  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-4xl font-semibold tracking-tight text-ink">Expenses</h1>
      ...
      <div className="mt-5 min-h-[320px] rounded-2xl border border-line bg-card">
        {filtered.length === 0 ? (
          <div className="flex min-h-[320px] flex-col items-center justify-center px-6 py-16 text-center">
            <p className="text-xl font-semibold text-ink">No expense records</p>
              ...
              <tbody>
                {filtered.map((item) => (
                  <tr key={item.id} className="border-b border-line/70 last:border-0">
                    ...
                    <td className="px-5 py-4 font-medium text-ink">{categoryName(item.category_id)}</td>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-xl border border-line px-3 text-sm text-muted hover:text-ink"
                >
                  Add
                </button>
              </div>
              ...
              <label className="block space-y-2">
                <span className="text-sm text-ink">Merchant</span>
                <input
                  value={merchant}
